...
**テーマファイル + 作りたい内容** をAIに渡すだけでスライドが作れます。

### 使い方

1. `prompts/themes/` から[テーマを選ぶ](#-シーン別おすすめテーマ)
2. テーマファイルの内容をAIに貼り付ける
3. 「〇〇についてのスライドを作って」と伝える

各テーマファイルには **プロンプト（コピー用）** と **使用例** が含まれているので、そのまま活用できます。
